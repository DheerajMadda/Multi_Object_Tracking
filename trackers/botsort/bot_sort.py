...
def xywh2xyxy(x):
    """
    Reference: from ultralytics.yolo.utils.ops import xywh2xyxy
...
class BoTSORT(object):
    ...
    def update(self, output_results, img):
        ...
        if len(dets) > 0:
            ...
            detections = [STrack(xyxy, s, c, f.detach().cpu().numpy()) for
